...
export const INGREDIENTS: Ingredient[] = [
  ...
  },
  {
    ...
    aliases: ["okra", "lady's finger", "ladies finger", "dherosh", "dhérosh", "ঢেঁড়শ", "bhindi", "bhendi", "vendi", "vindi"],
  ...
  {
    id: "bottle-gourd", name: "Bottle Gourd (Lau / Kodu)",
    aliases: ["bottle gourd", "lau", "লাউ", "calabash", "kodu", "kodoi", "kadu", "doodhi", "কদু"],
  ...
  {
    id: "ridge-gourd", name: "Ridge Gourd (Jhinga / Jhinge)",
    aliases: ["ridge gourd", "jhinge", "jhinga", "ঝিঙে", "ঝিঙ্গা", "luffa", "turai"],
    cal100: 17, category: "vegetable",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 150,
  },
  {
    id: "sponge-gourd", name: "Sponge Gourd (Dhundul)",
    aliases: ["dhundul", "dundul", "dhondul", "sponge gourd", "smooth luffa", "ধুন্দুল", "gilki"],
    cal100: 20, category: "vegetable",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 150,
  },
  {
    id: "spiny-gourd", name: "Spiny Gourd (Kakrol / Kakrol)",
    aliases: ["kakrol", "kakrol", "spiny gourd", "teasle gourd", "kantola", "কাঁকরোল", "kantoli"],
    cal100: 17, category: "vegetable",
    units: ["g", "piece"], gramsPerUnit: { piece: 30 },
    defaultUnit: "g", defaultAmount: 100,
  },
  {
    id: "elephant-yam", name: "Elephant Foot Yam (Ol Kochu)",
    aliases: ["ol kochu", "ol", "elephant foot yam", "suran", "jimikand", "ওল", "ওল কচু"],
    cal100: 118, category: "vegetable",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 100,
  },
  {
    id: "snake-gourd", name: "Snake Gourd (Chichinga)",
    aliases: ["snake gourd", "chichinga", "chichinga", "চিচিঙ্গা", "chachinga"],
    cal100: 18, category: "vegetable",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 150,
  },
  ...
  {
    id: "flat-beans", name: "Flat Beans (Sheem)",
    aliases: ["sheem", "shim", "flat beans", "hyacinth bean", "শিম"],
    cal100: 45, category: "vegetable",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 100,
  },
  {
    id: "french-beans", name: "French Beans / Green Beans",
    aliases: ["french beans", "green beans", "beans", "ফ্রেঞ্চ বিন"],
    cal100: 31, category: "vegetable",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 100,
  },
  {
    id: "kohlrabi", name: "Kohlrabi (Olkopi)",
    aliases: ["kohlrabi", "olkopi", "ওলকপি", "knol khol"],
    cal100: 27, category: "vegetable",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 100,
  },
  {
    id: "turnip", name: "Turnip (Shalgom)",
    aliases: ["turnip", "shalgom", "শালগম"],
    cal100: 28, category: "vegetable",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 100,
  },
  {
    id: "stem-amaranth", name: "Stem Amaranth (Data Shak)",
    aliases: ["data shak", "stem amaranth", "danta", "ডাটা শাক"],
    cal100: 23, category: "vegetable",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 100,
  },
  {
    id: "malabar-spinach", name: "Malabar Spinach (Pui Shak)",
    aliases: ["pui shak", "malabar spinach", "পুঁই শাক", "puishak"],
    cal100: 19, category: "vegetable",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 100,
  },
  {
    id: "taro-stolon", name: "Taro Stolon (Kochur Loti)",
    aliases: ["kochur loti", "kachur loti", "taro stolon", "কচুর লতি"],
    cal100: 40, category: "vegetable",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 100,
  },
  {
    id: "taro-leaves", name: "Taro Leaves (Kochu Shak)",
    aliases: ["kochu shak", "taro leaves", "kochu pata", "কচু শাক"],
    cal100: 42, category: "vegetable",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 100,
  },
  {
    id: "banana-flower", name: "Banana Flower (Mocha)",
    aliases: ["mocha", "banana flower", "banana blossom", "মোচা"],
    cal100: 51, category: "vegetable",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 100,
  },
  {
    id: "green-banana-stem", name: "Banana Stem (Thor)",
    aliases: ["thor", "banana stem", "কলার থোড়"],
    cal100: 42, category: "vegetable",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 100,
  },
  {
    id: "lettuce", name: "Lettuce (Lettuce Pata)",
    aliases: ["lettuce", "লেটুস", "salad leaf"],
    cal100: 15, category: "vegetable",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 50,
  },
  {
    id: "spring-onion", name: "Spring Onion (Peyaj Koli)",
    aliases: ["spring onion", "peyaj koli", "green onion", "পেঁয়াজ কলি", "scallion"],
    cal100: 32, category: "vegetable",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 50,
  },
  {
    id: "green-tomato", name: "Green Tomato (Kacha Tomato)",
    aliases: ["green tomato", "kacha tomato", "কাঁচা টমেটো"],
    cal100: 23, category: "vegetable",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 100,
  },
  {
    id: "long-bean-mula", name: "Radish Greens (Mula Shak)",
    aliases: ["mula shak", "radish greens", "মূলা শাক"],
    cal100: 28, category: "vegetable",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 100,
  },
  ...
  },
  {
    ...
    aliases: ["dragon fruit", "pitaya", "ড্রাগন ফল", "dragonfruit"],
    cal100: 60, category: "fruit",
    units: ["g", "piece"], gramsPerUnit: { piece: 250 },
    defaultUnit: "g", defaultAmount: 100,
  },
  {
    id: "grapes", name: "Grapes (Angur)",
    aliases: ["grapes", "angur", "আঙুর"],
    cal100: 69, category: "fruit",
    units: ["g", "piece"], gramsPerUnit: { piece: 6 },
    defaultUnit: "g", defaultAmount: 100,
  },
  {
    id: "pomegranate", name: "Pomegranate (Bedana / Anar)",
    aliases: ["pomegranate", "bedana", "anar", "বেদানা", "দালিম", "dalim"],
    cal100: 83, category: "fruit",
    units: ["g", "piece"], gramsPerUnit: { piece: 175 },
    defaultUnit: "g", defaultAmount: 100,
  },
  {
    id: "sapodilla", name: "Sapodilla (Sofeda)",
    aliases: ["sapodilla", "sofeda", "safeda", "chikoo", "সফেদা"],
    cal100: 83, category: "fruit",
    units: ["g", "piece"], gramsPerUnit: { piece: 100 },
    defaultUnit: "piece", defaultAmount: 1,
  },
  {
    id: "custard-apple", name: "Custard Apple (Ata / Sharifa)",
    aliases: ["custard apple", "ata", "sharifa", "sugar apple", "আতা"],
    cal100: 94, category: "fruit",
    units: ["g", "piece"], gramsPerUnit: { piece: 150 },
    defaultUnit: "piece", defaultAmount: 1,
  },
  {
    id: "black-plum", name: "Black Plum (Kalo Jam / Jamun)",
    aliases: ["black plum", "kalo jam", "jamun", "java plum", "কালো জাম"],
    cal100: 60, category: "fruit",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 100,
  },
  {
    id: "hog-plum", name: "Hog Plum (Amra)",
    aliases: ["hog plum", "amra", "আমড়া", "june plum"],
    cal100: 46, category: "fruit",
    units: ["g", "piece"], gramsPerUnit: { piece: 60 },
    defaultUnit: "piece", defaultAmount: 1,
  },
  {
    id: "indian-gooseberry", name: "Indian Gooseberry (Amloki)",
    aliases: ["amloki", "indian gooseberry", "amla", "আমলকি"],
    cal100: 44, category: "fruit",
    units: ["g", "piece"], gramsPerUnit: { piece: 12 },
    defaultUnit: "piece", defaultAmount: 2,
  },
  {
    id: "pear", name: "Pear (Nashpati)",
    aliases: ["pear", "nashpati", "নাশপাতি"],
    cal100: 57, category: "fruit",
    units: ["g", "piece"], gramsPerUnit: { piece: 180 },
    defaultUnit: "piece", defaultAmount: 1,
  },
  {
    id: "muskmelon", name: "Muskmelon (Bangi / Kharmuj)",
    aliases: ["muskmelon", "bangi", "kharmuj", "cantaloupe", "বাঙ্গি", "খরমুজ"],
    cal100: 34, category: "fruit",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 150,
  },
  {
    id: "olive-jolpai", name: "Olive (Jolpai)",
    aliases: ["jolpai", "olive", "ceylon olive", "জলপাই"],
    cal100: 70, category: "fruit",
    units: ["g", "piece"], gramsPerUnit: { piece: 15 },
    defaultUnit: "piece", defaultAmount: 2,
  },
  {
    id: "strawberry", name: "Strawberry",
    aliases: ["strawberry", "স্ট্রবেরি"],
    cal100: 32, category: "fruit",
    units: ["g", "piece"], gramsPerUnit: { piece: 12 },
    defaultUnit: "g", defaultAmount: 100,
  },
  {
    id: "sugarcane", name: "Sugarcane (Akh)",
    aliases: ["sugarcane", "akh", "আখ", "cane"],
    cal100: 65, category: "fruit",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 100,
  },
  {
    id: "palm-fruit", name: "Palm Fruit (Taal)",
    aliases: ["taal", "palm fruit", "তাল", "sugar palm"],
    cal100: 87, category: "fruit",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 100,
  },
  {
    id: "green-coconut", name: "Green Coconut Water Flesh (Daab)",
    aliases: ["daab", "green coconut", "tender coconut", "ডাব"],
    cal100: 40, category: "fruit",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 100,
  },
  ...
  // ── Everyday cooked dishes & bhortas ──
  {
    id: "alu-bhaji", name: "Alu Bhaji (Potato Stir-Fry)",
    aliases: ["alu bhaji", "aloo bhaji", "potato bhaji", "alu vaji", "আলু ভাজি"],
    cal100: 130, category: "prepared",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 120,
  },
  {
    id: "dim-bhaji", name: "Dim Bhaji / Egg Bhurji",
    aliases: ["dim bhaji", "egg bhurji", "dim bhuna", "scrambled egg curry", "ডিম ভাজি"],
    cal100: 180, category: "prepared",
    units: ["g", "piece"], gramsPerUnit: { piece: 70 },
    defaultUnit: "g", defaultAmount: 100,
  },
  {
    id: "veg-bhaji", name: "Mixed Vegetable Bhaji (Sabji)",
    aliases: ["vegetable bhaji", "sabji", "shobji", "mixed veg", "সবজি", "সবজি ভাজি"],
    cal100: 95, category: "prepared",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 150,
  },
  {
    id: "alu-bhorta", name: "Alu Bhorta (Mashed Potato)",
    aliases: ["alu bhorta", "aloo bhorta", "mashed potato", "আলু ভর্তা"],
    cal100: 140, category: "prepared",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 100,
  },
  {
    id: "begun-bhorta", name: "Begun Bhorta (Mashed Eggplant)",
    aliases: ["begun bhorta", "baingan bharta", "eggplant mash", "বেগুন ভর্তা"],
    cal100: 110, category: "prepared",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 100,
  },
  {
    id: "dal-cooked", name: "Dal (cooked, thin)",
    aliases: ["dal", "daal", "lentil soup", "ডাল", "patla dal"],
    cal100: 90, category: "prepared",
    units: ["g", "cup"], gramsPerUnit: { cup: 240 },
    defaultUnit: "cup", defaultAmount: 1,
  },
  {
    id: "chicken-curry", name: "Chicken Curry / Murgir Torkari (cooked, with gravy)",
    aliases: ["chicken curry", "murgir mangsho", "chicken jhol", "মুরগির মাংস", "chicken bhuna", "murgir torkari", "chicken torkari", "মুরগির তরকারি"],
    cal100: 180, category: "prepared",
    units: ["g", "piece"], gramsPerUnit: { piece: 90 },
    defaultUnit: "piece", defaultAmount: 1,
  },
  {
    id: "beef-curry", name: "Beef Curry / Goru Torkari (cooked, with gravy)",
    aliases: ["beef curry", "gorur mangsho", "beef bhuna", "গরুর মাংস", "goru torkari", "gorur torkari", "beef torkari", "goru", "গরুর তরকারি"],
    cal100: 250, category: "prepared",
    units: ["g", "piece"], gramsPerUnit: { piece: 60 },
    defaultUnit: "g", defaultAmount: 120,
  },
  {
    id: "fish-curry", name: "Fish Curry (cooked, with gravy)",
    aliases: ["fish curry", "macher jhol", "মাছের ঝোল", "fish jhol"],
    cal100: 150, category: "prepared",
    units: ["g", "piece"], gramsPerUnit: { piece: 100 },
    defaultUnit: "piece", defaultAmount: 1,
  },
  {
    id: "polao", name: "Polao / Morog Polao (per cup)",
    aliases: ["polao", "pulao", "morog polao", "পোলাও", "fried rice"],
    cal100: 200, category: "prepared",
    units: ["g", "cup"], gramsPerUnit: { cup: 150 },
    defaultUnit: "cup", defaultAmount: 1,
  },
  {
    id: "tehari", name: "Tehari / Beef Khichuri (per plate)",
    aliases: ["tehari", "tehari", "beef khichuri", "তেহারি"],
    cal100: 240, category: "prepared",
    units: ["g", "cup"], gramsPerUnit: { cup: 200 },
    defaultUnit: "cup", defaultAmount: 1,
  },

  // ── Street snacks & fried items ──
  {
    id: "piyaju", name: "Piyaju (Lentil-Onion Fritter)",
    aliases: ["piyaju", "peyaju", "lentil fritter", "পিয়াজু"],
    cal100: 280, category: "prepared",
    units: ["piece", "g"], gramsPerUnit: { piece: 25 },
    defaultUnit: "piece", defaultAmount: 2,
  },
  {
    id: "beguni", name: "Beguni (Eggplant Fritter)",
    aliases: ["beguni", "eggplant fritter", "বেগুনি"],
    cal100: 260, category: "prepared",
    units: ["piece", "g"], gramsPerUnit: { piece: 35 },
    defaultUnit: "piece", defaultAmount: 1,
  },
  {
    id: "alu-chop", name: "Alu Chop (Potato Fritter)",
    aliases: ["alu chop", "aloo chop", "potato chop", "আলুর চপ"],
    cal100: 250, category: "prepared",
    units: ["piece", "g"], gramsPerUnit: { piece: 50 },
    defaultUnit: "piece", defaultAmount: 1,
  },
  {
    id: "dim-chop", name: "Dim Chop (Egg Chop)",
    aliases: ["dim chop", "egg chop", "egg cutlet", "ডিমের চপ"],
    cal100: 240, category: "prepared",
    units: ["piece", "g"], gramsPerUnit: { piece: 70 },
    defaultUnit: "piece", defaultAmount: 1,
  },
  {
    id: "chicken-roll", name: "Chicken Roll (per roll)",
    aliases: ["chicken roll", "egg roll", "roll", "চিকেন রোল"],
    cal100: 260, category: "prepared",
    units: ["piece", "g"], gramsPerUnit: { piece: 150 },
    defaultUnit: "piece", defaultAmount: 1,
  },
  {
    id: "jhal-muri", name: "Jhal Muri (per bowl)",
    aliases: ["jhal muri", "jhalmuri", "spicy puffed rice", "ঝালমুড়ি"],
    cal100: 180, category: "prepared",
    units: ["g", "cup"], gramsPerUnit: { cup: 40 },
    defaultUnit: "cup", defaultAmount: 1,
  },
  {
    id: "chanachur", name: "Chanachur / Bombay Mix",
    aliases: ["chanachur", "chana chur", "bombay mix", "namkeen", "চানাচুর"],
    cal100: 490, category: "prepared",
    units: ["g"], gramsPerUnit: {},
    defaultUnit: "g", defaultAmount: 30,
  },
  {
    id: "fuchka", name: "Fuchka / Panipuri (per plate of 6)",
    aliases: ["fuchka", "phuchka", "panipuri", "golgappa", "ফুচকা"],
    cal100: 240, category: "prepared",
    units: ["piece", "g"], gramsPerUnit: { piece: 20 },
    defaultUnit: "piece", defaultAmount: 6,
  },
  {
    id: "chotpoti", name: "Chotpoti (per plate)",
    aliases: ["chotpoti", "chatpati", "চটপটি"],
    cal100: 150, category: "prepared",
    units: ["g", "cup"], gramsPerUnit: { cup: 200 },
    defaultUnit: "cup", defaultAmount: 1,
  },
  {
    id: "singara", name: "Singara (Vegetable, per piece)",
    aliases: ["singara", "shingara", "সিঙ্গাড়া"],
    cal100: 310, category: "prepared",
    units: ["piece", "g"], gramsPerUnit: { piece: 40 },
    defaultUnit: "piece", defaultAmount: 1,
  },
  {
    id: "luchi", name: "Luchi / Dal Puri (per piece)",
    aliases: ["luchi", "dal puri", "লুচি", "ডাল পুরি"],
    cal100: 320, category: "prepared",
    units: ["piece", "g"], gramsPerUnit: { piece: 30 },
    defaultUnit: "piece", defaultAmount: 2,
  },
  {
    id: "sandwich-veg", name: "Sandwich (Vegetable/Egg, per half)",
    aliases: ["sandwich", "veg sandwich", "egg sandwich", "স্যান্ডউইচ"],
    cal100: 250, category: "prepared",
    units: ["piece", "g"], gramsPerUnit: { piece: 90 },
    defaultUnit: "piece", defaultAmount: 1,
  },
  {
    id: "toast-biscuit", name: "Toast Biscuit (Nashta Biscuit)",
    aliases: ["toast biscuit", "toast", "rusk", "টোস্ট বিস্কুট"],
    cal100: 410, category: "prepared",
    units: ["piece", "g"], gramsPerUnit: { piece: 12 },
    defaultUnit: "piece", defaultAmount: 2,
  },
  {
    id: "nun-biscuit", name: "Salt Biscuit (Nun Biscuit)",
    aliases: ["nun biscuit", "salt biscuit", "নোনতা বিস্কুট", "salted biscuit"],
    cal100: 450, category: "prepared",
    units: ["piece", "g"], gramsPerUnit: { piece: 8 },
    defaultUnit: "piece", defaultAmount: 3,
  },
